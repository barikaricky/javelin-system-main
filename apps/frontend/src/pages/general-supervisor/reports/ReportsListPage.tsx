...
export default function GeneralSupervisorReportsListPage() {
  ...
  const fetchReports = async (isRefresh = false) => {
    try {
      ...
      console.log('📊 Fetching reports for General Supervisor...');
        ...
        <div className="mb-6 animate-fade-in">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link
                to="/general-supervisor/reports/analytics"
              ...
              <Link
                to="/general-supervisor/reports/create"
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Link
                          to={`/general-supervisor/reports/${report._id}`}
                        ...
                        {(report.status === 'DRAFT' || report.status === 'REVISION_REQUIRED') && (
                          <Link
                            to={`/general-supervisor/reports/${report._id}/edit`}
                            className="p-2 text-blue-600 hover:bg-blue-50 rounded-lg transition-all"
                            title="Edit Report"
                          >
                        ...
                        {/* NO DELETE BUTTON for General Supervisor */}
                      </div>
                    </div>
                  </div>
                </div>
