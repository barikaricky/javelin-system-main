...
export default function ReportDetailsPage() {
  ...
  const fetchReport = async () => {
    try {
      ...
      navigate('/general-supervisor/reports');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 p-4 md:p-6 lg:p-8">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-6">
          <button
            onClick={() => navigate('/general-supervisor/reports')}
          ...
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-4">
            ...
            {/* Action Buttons - NO APPROVE/REJECT/DELETE for General Supervisor */}
            <div className="flex flex-wrap gap-2">
              ...
              {!report.isLocked && (report.status === 'DRAFT' || report.status === 'REVISION_REQUIRED') && (
                <button
                  onClick={() => navigate(`/general-supervisor/reports/${id}/edit`)}
