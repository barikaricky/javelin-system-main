          ...
          >
            ...
            <div style={{
              ...
              <div>
                ...
                <div style={{ color: '#EAB308', fontWeight: '600' }}>{formatDate(selectedStaff.createdAt || selectedStaff.dateOfJoining)}</div>
              </div>
              <div style={{ textAlign: 'right' }}>
                <div style={{ color: '#FFFFFF', opacity: 0.8 }}>EXPIRES</div>
                <div style={{ color: '#EAB308', fontWeight: '600' }}>{getExpiryDate(selectedStaff.createdAt || selectedStaff.dateOfJoining)}</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="mt-6 sm:mt-8 bg-white rounded-lg shadow-sm p-4 sm:p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          <div className="border-l-4 border-blue-600 pl-4">
            ...
            <div className="text-sm sm:text-base font-semibold text-gray-900">CR80</div>
            <div className="text-xs text-gray-500">85.60 × 53.98 mm</div>
          </div>
          
          <div className="border-l-4 border-blue-600 pl-4">
            <div className="text-xs sm:text-sm text-gray-600 mb-1">Material</div>
            <div className="text-sm sm:text-base font-semibold text-gray-900">PVC Plastic</div>
            <div className="text-xs text-gray-500">0.76mm thickness</div>
          </div>
          
          <div className="border-l-4 border-blue-600 pl-4">
            <div className="text-xs sm:text-sm text-gray-600 mb-1">QR Code</div>
            <div className="text-sm sm:text-base font-semibold text-gray-900">Version 10</div>
            <div className="text-xs text-gray-500">Error correction: H</div>
          </div>
          
          <div className="border-l-4 border-blue-600 pl-4">
            <div className="text-xs sm:text-sm text-gray-600 mb-1">Validity</div>
            <div className="text-sm sm:text-base font-semibold text-gray-900">1 Year</div>
            <div className="text-xs text-gray-500">From issue date</div>
          </div>
        </div>
      </div>
