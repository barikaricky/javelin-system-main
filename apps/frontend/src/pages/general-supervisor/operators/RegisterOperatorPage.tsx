...
export default function RegisterOperatorPage() {
  ...
  const fetchSupervisors = async () => {
    try {
      const response = await api.get('/general-supervisor/supervisors', {
        params: {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const submitData: any = {
        ...formData,
        status: 'ACTIVE', // GS can directly activate operators
      };
      ...
      const response = await api.post('/general-supervisor/operators/register', submitData);
        ...
        <div className="max-w-4xl mx-auto mb-4 print:hidden">
          <div className="bg-white rounded-lg shadow-md p-4 flex items-center justify-between">
            ...
            <div className="flex gap-3">
              ...
              <button
                onClick={() => navigate('/general-supervisor/operators')}
                  ...
                  <div className="grid grid-cols-2 gap-12">
                    ...
                    <div className="relative" style={{ minHeight: '180px' }}>
                      ...
                      <div className="relative" style={{ width: '250px' }}>
                        ...
                        <p className="text-sm text-gray-600 mt-2">General Supervisor / Authorized Officer</p>
