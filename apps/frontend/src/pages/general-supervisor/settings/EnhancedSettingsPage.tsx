                ...
                <div className="flex items-center gap-6">
                  <div className="relative">
                    {profile.profilePhoto ? (
                      ...
                      <div className="w-24 h-24 rounded-full bg-gradient-to-br from-emerald-500 to-emerald-600 flex items-center justify-center text-white text-2xl font-bold border-4 border-white shadow-lg">
                        {profile.firstName && profile.lastName ? `${profile.firstName[0]}${profile.lastName[0]}` : 'GS'}
                      </div>
                    )}
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">General Supervisor</p>
              ...
              <div className="space-y-8">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-emerald-100 text-sm">Generate and manage your digital identification</p>
                      </div>
                    </div>
                ...
                <div className="grid grid-cols-3 gap-6 p-6 bg-gray-50 rounded-xl">
                  ...
                  <div className="text-center border-x border-gray-200">
                    <div className="text-3xl font-bold text-emerald-600 mb-1">1 Year</div>
                    <div className="text-sm text-gray-600">Validity Period</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-emerald-600 mb-1">PDF</div>
                ...
                <div className="flex justify-center">
                  <Link
                    to="/general-supervisor/id-cards"
                    className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-emerald-600 to-teal-600 text-white rounded-xl hover:from-emerald-700 hover:to-teal-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                  >
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex gap-4">
                      <button
                        ...
                        className={`flex items-center gap-3 px-4 py-3 border-2 rounded-lg transition-colors ${
                          preferences.theme === 'light' ? 'border-emerald-600 bg-emerald-50' : 'border-gray-200'
                        }`}
                      >
                        <Sun size={20} className={preferences.theme === 'light' ? 'text-emerald-600' : 'text-gray-400'} />
                        <span className={preferences.theme === 'light' ? 'text-emerald-600 font-medium' : 'text-gray-600'}>Light</span>
                      </button>
                      <button
                        onClick={() => setPreferences({ ...preferences, theme: 'dark' })}
                        className={`flex items-center gap-3 px-4 py-3 border-2 rounded-lg transition-colors ${
                          preferences.theme === 'dark' ? 'border-emerald-600 bg-emerald-50' : 'border-gray-200'
                        }`}
                      >
                        <Moon size={20} className={preferences.theme === 'dark' ? 'text-emerald-600' : 'text-gray-400'} />
                        <span className={preferences.theme === 'dark' ? 'text-emerald-600 font-medium' : 'text-gray-600'}>Dark</span>
                      </button>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full max-w-xs px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 bg-white"
                    >
