...
export default function ManagerMessagingPage() {
  ...
  // Manager can only send broadcasts to supervisors and operators
  const MANAGER_BROADCAST_ROLES: Record<string, string> = {
    SUPERVISOR: 'Supervisors',
    GENERAL_SUPERVISOR: 'General Supervisors',
    OPERATOR: 'Operators',
  };
  ...
  return (
    <div className="h-[calc(100vh-12rem)] sm:h-[calc(100vh-10rem)] md:h-[calc(100vh-8rem)] flex bg-gray-100 rounded-lg md:rounded-xl overflow-hidden">
      ...
      {/* New Broadcast Modal - Manager version (limited roles) */}
      {showNewBroadcast && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-md max-h-[80vh] flex flex-col">
            <div className="p-4 border-b flex items-center justify-between">
            ...
            <div className="p-4 space-y-4 overflow-y-auto">
              ...
              <div>
                ...
                <div className="space-y-2">
                  {Object.entries(MANAGER_BROADCAST_ROLES).map(([role, label]) => (
