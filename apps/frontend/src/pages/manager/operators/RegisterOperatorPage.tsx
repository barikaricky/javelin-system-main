...
export default function RegisterOperatorPage() {
  ...
  // Debug logging
  useEffect(() => {
    console.log('Manager Registration Page - State:', { showSuccess, registeredOperator: !!registeredOperator, qrCodeUrl: !!qrCodeUrl });
  }, [showSuccess, registeredOperator, qrCodeUrl]);
  ...
  if (showSuccess) {
    ...
    return (
      <div className="min-h-screen bg-gray-50 p-4" key="manager-receipt-v2">
        ...
        <div className="max-w-4xl mx-auto mb-4 print:hidden">
          <div className="bg-white rounded-lg shadow-md p-4 flex items-center justify-between">
            ...
            <div className="flex gap-3">
              ...
              <button
                onClick={() => navigate('/manager/operators')}
                  ...
                  <div className="grid grid-cols-2 gap-12">
                    ...
                    <div className="relative" style={{ minHeight: '180px' }}>
                      ...
                      <div className="relative" style={{ width: '250px' }}>
                        ...
                        <p className="text-sm text-gray-600 mt-2">Manager / Authorized Officer</p>
