...
// Nigerian Banks (Commercial, Merchant, and Digital Banks)
...
export default function RegisterSecretaryPage() {
  ...
  const steps = [
    ...
    { number: 2, title: 'Work Details', icon: Building2 },
    ...
    switch (step) {
      case 1:
        return !!(formData.firstName && formData.lastName && formData.email && 
                  formData.phone && formData.gender && formData.dateOfBirth && 
                  formData.passportPhoto);
      case 2:
        return !!(formData.address && formData.state && formData.regionAssigned && 
                  formData.startDate);
      case 3:
        return !!(formData.salary > 0 && formData.salaryCategory && formData.bankName && 
    ...
    try {
      ...
      if (formData.passportPhoto) {
        ...
        passportPhotoBase64 = await new Promise<string>((resolve, reject) => {
          ...
          reader.readAsDataURL(formData.passportPhoto!);
        });
      }
      ...
      const submitData = {
        ...
        regionAssigned: formData.regionAssigned,
        ...
        <div className="bg-white rounded-2xl shadow-xl max-w-2xl w-full p-8">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-2">
              Secretary Registered Successfully!
            </h2>
            <p className="text-gray-600">
              The secretary account has been created. Please share the login credentials below.
            </p>
          </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 mb-6">
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <p className="font-mono text-gray-900">{credentials.email}</p>
              </div>
              <div>
                <p className="text-sm text-gray-600">Temporary Password</p>
                <p className="font-mono font-semibold text-red-600 bg-red-50 p-2 rounded border border-red-200">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
            <p className="text-sm text-yellow-800">
              <strong>Important:</strong> The secretary must change this password on first login. 
          ...
          <div className="flex gap-4">
            ...
            <button
              onClick={() => navigate('/manager/secretaries')}
  ...
  return (
    <div className="p-4 sm:p-6 max-w-4xl mx-auto">
      ...
      <div className="mb-6 sm:mb-8">
        ...
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Register Secretary</h1>
        <p className="text-sm sm:text-base text-gray-600 mt-2">
          Add a new secretary to handle financial records, budgets, and location management
        </p>
      </div>
            ...
            <div key={step.number} className="flex-1 flex items-center">
              <div className={`flex items-center gap-3 ${index < steps.length - 1 ? 'flex-1' : ''}`}>
                ...
                <div className="hidden md:block">
                  <p className={`font-medium ${currentStep >= step.number ? 'text-emerald-600' : 'text-gray-500'}`}>
                    Step {step.number}
                  </p>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6 lg:p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2">
                ...
                <p className="mt-2 text-sm text-gray-500">
                  This photo will be used to generate the Secretary ID card
                </p>
              </div>
            </div>
          </div>
        ...
        {currentStep === 2 && (
          <div className="space-y-4 sm:space-y-6">
            <h2 className="text-lg sm:text-xl font-bold text-gray-900 mb-4 sm:mb-6">Work Details</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                >
                  ...
                  {formData.state && STATE_LGAS[formData.state]?.map(lga => (
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Region Assigned <span className="text-red-500">*</span>
                </label>
                <select
                  value={formData.regionAssigned}
                  onChange={(e) => handleInputChange('regionAssigned', e.target.value)}
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
                >
        ...
        {currentStep === 3 && (
          <div className="space-y-4 sm:space-y-6">
            <h2 className="text-lg sm:text-xl font-bold text-gray-900 mb-4 sm:mb-6">Salary & Bank Information</h2>
        ...
        {/* Navigation Buttons */}
        <div className="flex items-center justify-between mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-gray-200 gap-3">
          <button
            onClick={handlePrevious}
            disabled={currentStep === 1}
            className="flex items-center gap-1 sm:gap-2 px-4 sm:px-6 py-2.5 sm:py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed font-medium text-sm sm:text-base"
          >
          ...
          {currentStep < 3 ? (
            <button
              onClick={handleNext}
              className="flex items-center gap-1 sm:gap-2 px-4 sm:px-6 py-2.5 sm:py-3 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-colors font-medium text-sm sm:text-base"
            >
              Next
            ...
            >
              {isSubmitting ? (
                ...
                <>
                  ...
                  <span className="hidden sm:inline">Register Secretary</span>
