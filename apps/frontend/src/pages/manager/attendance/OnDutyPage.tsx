...
export default function ManagerOnDutyPage() {
  ...
  const fetchOnDutyPersonnel = async (isRefresh = false) => {
    try {
      ...
      console.log('🔍 Fetching on-duty personnel from /managers/dashboard/stats...');
      ...
      console.log('📋 On Duty Personnel Fetched (Manager):', {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-emerald-50 to-green-50 p-4 md:p-6 lg:p-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                disabled={refreshing}
                className="px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-all flex items-center gap-2 shadow-lg disabled:opacity-50"
              >
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-start gap-4 mb-4">
                      <div className="relative flex-shrink-0">
                        ...
                        <div className={`w-16 h-16 rounded-full bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center text-white font-bold text-lg border-4 border-emerald-100 shadow-md ${profilePhoto ? 'hidden' : ''}`}>
                    ...
                    <button
                      ...
                      className="mt-4 w-full py-2.5 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white rounded-lg hover:from-emerald-700 hover:to-emerald-800 transition-all flex items-center justify-center gap-2 font-medium shadow-md group-hover:shadow-lg"
                    >
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50 animate-fade-in">
          <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto animate-scale-in">
                  ...
                  return (
                    <>
                      ...
                      <div>
                        ...
                        <p className="text-emerald-100">Employee ID: {selectedPerson.operatorId?.employeeId}</p>
                      </div>
                    </>
                  );
                })()}
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <span className="inline-block px-3 py-1.5 bg-emerald-100 text-emerald-800 rounded-lg font-semibold">
            ...
            <div className="p-6 border-t border-gray-200 bg-gray-50 rounded-b-2xl">
              <button
                onClick={() => setShowDetailsModal(false)}
                className="w-full py-3 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white rounded-lg hover:from-emerald-700 hover:to-emerald-800 transition-all font-medium shadow-md"
              >
                Close
              </button>
            </div>
