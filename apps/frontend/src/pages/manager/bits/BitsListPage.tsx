  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Security Bits Overview</h1>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-lg shadow-sm p-12 text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">No bits found</h3>
            <p className="text-gray-600">No security bits match your search criteria</p>
          </div>
        ) : (
                ...
                <div className="pt-4 border-t border-gray-100">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
                        navigate(`/manager/bits/${bit._id}/details`);
                      }}
                    ...
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
                        navigate(`/manager/bits/${bit._id}/edit`);
                      }}
