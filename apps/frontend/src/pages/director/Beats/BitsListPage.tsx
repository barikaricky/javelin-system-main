    ...
    <div className="min-h-screen bg-gray-50 p-3 sm:p-4 md:p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-4 sm:mb-6">
          <div>
            <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900">Security Beats Overview</h1>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-lg shadow-sm p-8 sm:p-12 text-center">
            ...
            <p className="text-sm sm:text-base text-gray-600">No security beats match your search criteria</p>
          </div>
        ) : (
                ...
                <div className="pt-3 sm:pt-4 border-t border-gray-100">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
                        navigate(`/director/beats/${bit._id}/details`);
                      }}
                    ...
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
                        navigate(`/director/beats/${bit._id}/edit`);
                      }}
