...
import {
  ...
  Eye, Edit2, Banknote, Building2, CreditCard, FileText,
  AlertCircle, CheckCircle, PieChart as PieChartIcon
} from 'lucide-react';
import { api } from '../../../lib/api';
import MoneyInCharts from './MoneyInCharts';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">
            Track and manage all incoming money
          </p>
        </div>
        <div className="flex flex-wrap gap-2">
          ...
          <button
            onClick={() => navigate('/secretary/money-in/record')}
                  ...
                  <tr key={record._id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <div className="flex items-center justify-end gap-2">
                        <button
                          onClick={() => navigate(`/secretary/money-in/${record._id}`)}
                        ...
                        <button
                          onClick={() => navigate(`/secretary/money-in/${record._id}/edit`)}
