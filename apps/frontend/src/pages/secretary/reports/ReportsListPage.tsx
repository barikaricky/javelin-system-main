        ...
        <div className="mb-6 animate-fade-in">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link
                to="/secretary/reports/analytics"
              ...
              <Link
                to="/secretary/reports/create"
                className="px-6 py-2 bg-gradient-to-r from-purple-600 to-purple-700 text-white rounded-lg hover:from-purple-700 hover:to-purple-800 transition-all flex items-center gap-2 shadow-lg font-medium"
              >
              ...
              <div className="mt-4 pt-4 border-t border-gray-200 grid grid-cols-1 md:grid-cols-4 gap-4 animate-fade-in">
                ...
                <div className="md:col-span-4 flex justify-end">
                  <button
                    ...
                    className="px-4 py-2 text-purple-600 hover:bg-purple-50 rounded-lg transition-all text-sm font-medium"
                  >
                    Clear All Filters
                  </button>
                </div>
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Link
                          to={`/secretary/reports/${report._id}`}
                        ...
                        <Link
                          to={`/secretary/reports/${report._id}/edit`}
                          className="p-2 text-purple-600 hover:bg-purple-50 rounded-lg transition-all"
                          title="Edit Report"
                        >
                          <Edit className="w-4 h-4" />
                        </Link>
                        {/* Secretary CANNOT delete reports - No delete button (only Director can delete) */}
                      </div>
                    </div>
                  </div>
                </div>
