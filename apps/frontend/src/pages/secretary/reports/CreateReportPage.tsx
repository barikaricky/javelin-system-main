        ...
        <div className="bg-white rounded-xl shadow-lg p-6 md:p-8 border border-gray-100">
          ...
          <div className="flex flex-col md:flex-row gap-3 pt-6 border-t border-gray-200">
            ...
            <button
              ...
              disabled={saving}
              className="flex-1 px-6 py-3 bg-gradient-to-r from-purple-600 to-purple-700 text-white rounded-lg hover:from-purple-700 hover:to-purple-800 transition-all flex items-center justify-center gap-2 font-medium shadow-lg disabled:opacity-50"
            >
              {saving ? (
                <>
          ...
          <div className="mt-6 bg-purple-50 border border-purple-200 rounded-lg p-4">
            <div className="flex gap-3">
              ...
              <div className="text-sm text-purple-900">
                <p className="font-semibold mb-1">Secretary Privileges:</p>
                <ul className="list-disc list-inside space-y-1 text-purple-800">
                  <li>Your reports are automatically approved upon submission</li>
                  <li>No review process required for Secretary-created reports</li>
